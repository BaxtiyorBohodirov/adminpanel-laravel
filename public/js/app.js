...
var _require2 = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"),
    toInteger = _require2.toInteger,
    countBy = _require2.countBy;
...
$('.edit-add input').on('keypress', function (ev) {
  if (ev.key === 'Enter') {
    ...
    if ($('select[name=status]').val()) {
      arr.push({
        name: $('select[name=status]').attr('name'),
        value: $('select[name=status]').val()
      });
    }

    var _iterator = _createForOfIteratorHelper($('.edit-add input')),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var item = _step.value;
        if ($(item).val() !== '') arr.push({
          name: $(item).attr('name'),
          value: $(item).val()
        });
      }
...
$('.edit-add select').on('change', function () {
  ...
  var _iterator2 = _createForOfIteratorHelper($('.edit-add input')),
      _step2;
...
$('.create-product input[type=file]').change(function (ev) {
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    var image = document.querySelector('.create-product div.images img:last-child');
...
function changeAttr(mutation) {
  var _iterator4 = _createForOfIteratorHelper(mutation),
      _step4;
...
var images = document.querySelectorAll('.create-product div.images img');
